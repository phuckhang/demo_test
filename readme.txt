...
1. In order to run the test, make sure that the environments below are available:
- Install Java
- Install Maven
Refer: https://www.mkyong.com/maven/how-to-install-maven-in-windows/

2. Run automation test (Support 2 browsers which are chrome and firefox):
- Go to project's root folder(demo_test) which contains source code and use following command line to run:
